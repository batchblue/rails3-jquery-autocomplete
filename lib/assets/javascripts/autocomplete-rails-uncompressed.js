...
(function(jQuery)
{
  ...
  jQuery.railsAutocomplete.options = {
    'show-no-matches': 'true',
    'no-matches-label': 'no existing match'
  }
      ...
      jQuery(e).autocomplete({
        ...
        source: function( request, response ) {
          ...
          jQuery.getJSON( jQuery(e).attr('data-autocomplete'), params, function() {
            ...
            if(arguments[0].length === 0 && options['show-no-matches'] === 'true') {
              arguments[0] = [];
              arguments[0][0] = { id: "", label: options['no-matches-label'] };
            }
